...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white mt-auto relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-purple-600/10 to-transparent rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button className="px-5 py-3 bg-gradient-to-r from-purple-600 to-violet-600 rounded-xl hover:shadow-lg hover:shadow-purple-500/50 transition-all hover:scale-105">
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="w-11 h-11 rounded-xl bg-white/10 hover:bg-gradient-to-r hover:from-purple-600 hover:to-violet-600 flex items-center justify-center transition-all hover:scale-110 backdrop-blur-sm border border-white/10"
                >
        ...
        <div className="h-1 bg-gradient-to-r from-purple-600 via-violet-600 to-cyan-600"></div>
      </div>
    </footer>
  );
}
