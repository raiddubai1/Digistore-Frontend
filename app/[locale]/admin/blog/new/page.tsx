...
import { ArrowLeft, Save, Loader2, Image as ImageIcon, Eye, FileText } from "lucide-react";
      ...
      <form onSubmit={(e) => handleSubmit(e)} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Supports HTML tags like &lt;p&gt;, &lt;h2&gt;, &lt;ul&gt;, &lt;strong&gt;, etc.</p>
          </div>
