    ...
    try {
      ...
      if (response.data?.success && response.data?.data) {
        ...
        setFormData({
          ...
          authorName: post.authorName || "Digistore1 Team",
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Update post content and settings</p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          <button
            ...
            className={`flex items-center justify-center gap-2 px-6 py-3 rounded-lg ${
              deleteConfirm ? "bg-red-500 text-white" : "bg-red-100 text-red-600 hover:bg-red-200"
            }`}
          >
            <Trash2 className="w-5 h-5" />
            {deleteConfirm ? "Click to Confirm" : "Delete Post"}
          </button>
