      ...
      <div className="lg:hidden min-h-screen bg-white pb-24">
        ...
        <div className="relative">
          ...
          <Link
            ...
            className="absolute top-4 left-4 w-10 h-10 bg-white/90 dark:bg-slate-700/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md z-10"
          >
          ...
          <div className="absolute top-4 right-4 flex gap-2 z-10">
            <button
              onClick={handleShare}
              className="w-10 h-10 bg-white/90 dark:bg-slate-700/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md"
            >
            ...
            >
              <Heart
                className={`w-5 h-5 ${isWishlisted ? 'fill-red-500 text-red-500' : 'text-gray-800 dark:text-white'}`}
              />
            </button>
          </div>
